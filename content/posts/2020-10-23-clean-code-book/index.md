...
public class RowColumnPagePrinter {
   ...
   public RowColumnPagePrinter(
    int rowsPerPage, int columnsPerPage, String pageHeader) {
   ...
   public void print(int data[]) {
      ...
      for (int firstIndexOnPage = 0;
         ...
         int lastIndexOnPage = Math.min(
             firstIndexOnPage + numbersPerPage - 1, data.length - 1);
...
Did you understand clearly how and why it works? If you did without having prior context, you're truly outstanding! For the rest of us, however, this class probably made us scratch our heads more than it should.
...
public class PrimeGenerator {
   static int[] primes;
   static ArrayList<Integer> multiplesOfPrimeFactors;
